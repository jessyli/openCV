...
public class DetectProfileFace {
...
//				System.out.println(images[i].size());
			    ...
			    faceDetector_profile.detectMultiScale(images[i], faceDetections, 1.10, 3, 
			                   Objdetect.CASCADE_DO_CANNY_PRUNING, new Size(8, 8), new Size(max/2, max/2));
